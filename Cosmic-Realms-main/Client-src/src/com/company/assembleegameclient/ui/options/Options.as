...
public class Options extends Sprite {
    ...
    private static function makeFpsModeSelectLabels():Vector.<StringBuilder> {
        return (new <StringBuilder>[new StaticStringBuilder("Normal"), new StaticStringBuilder("Heavy")]);
    }
    ...
    private function addExperimentalOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("BitmapQuality", makeFpsModeSelectLabels(), ["1", "2"], "Outline Of Everything", "Changes the outline width for everything", refreshFpsMode));
